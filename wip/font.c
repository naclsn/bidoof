 ...
 * somewhat modified (eg. swap "aux.h" for "frame.h")
 */
/*
...
void makeRasterFont(void)
{
    ...
    for (GLuint k = 32; k < 127; k++) {
        glNewList(fontOffset+k, GL_COMPILE);
        //glBitmap(8, 13, 0.0, 2.0, 10.0, 0.0, rasters[k-32]);
        glBitmap(8, 13, 0.f, 0.f, 10.0f, 0.0f, rasters[k-32]);
        glEndList();
    }
}
...
void myReshape(Frame* f, int w, int h)
{
    (void)f;
    (void)w;
    (void)h;
